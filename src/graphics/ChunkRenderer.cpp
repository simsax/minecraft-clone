...
void ChunkRenderer::SetSkyColor(const glm::vec3 &skyColor) {
    m_SkyColor = skyColor;
}

void ChunkRenderer::SetSunColor(const glm::vec3 &sunColor) {
    m_SunColor = sunColor;
}

void ChunkRenderer::SetLightPos(const glm::vec3 &lightPos) {
    m_LightPos = lightPos;
}

void ChunkRenderer::SetViewPos(const glm::vec3 &viewPos) {
    m_ViewPos = viewPos;
}
...
void ChunkRenderer::SetSunDir(const glm::vec3 &sunDir) {
    m_SunDir = sunDir;
}

void ChunkRenderer::SetIsDay(bool isDay) {
    m_IsDay = isDay;
}

void ChunkRenderer::SetIboCount(size_t count) {
    m_IBO.SetCount(count);
}

uint32_t ChunkRenderer::GetVaoId() const {
    return m_VAO.GetId();
}

uint32_t ChunkRenderer::GetStride() const {
    return m_VertexLayout.GetStride();
}
...
void ChunkRenderer::SetDeltaTime(float deltaTime) {
