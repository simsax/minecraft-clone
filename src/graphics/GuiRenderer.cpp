...
void GuiRenderer::Init(glm::mat4* proj)
{
    m_Proj = proj;
    m_Shader.Init(std::string(SOURCE_DIR) + "/res/shaders/shader_gui.vert",
...
void GuiRenderer::Render(const Texture& texture, const glm::vec2& position, const glm::vec2& scale)
{
